...
module "security_group" {
  source              = "../000-Modules/security-groups"
...
module "lb_target_group" {
  source                   = "../000-Modules/load-balancer-target-group"
...
module "alb" {
  source                          = "../000-Modules/load-balancer"
...
module "hosted_zone" {
  source          = "../000-Modules/hosted-zone"
  domain_name     = "jenkins.geekyrbhalala.online"
  aws_lb_dns_name = module.alb.aws_lb_dns_name
  aws_lb_zone_id  = module.alb.aws_lb_zone_id
}

module "aws_ceritification_manager" {
  source         = "../000-Modules/certificate-manager"
  domain_name    = "jenkins.geekyrbhalala.online"
